...
#define HEATER_0_MAXTEMP 245//ptfe
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 3200, 84.8*2 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30, 12, -0.8 }
...
#define X_MIN_POS -60 //getauscht
#define Y_MIN_POS -83
#define Z_MIN_POS 0
#define X_MAX_POS 274
#define Y_MAX_POS 200
#define Z_MAX_POS 376.5
...
#define HOMING_FEEDRATE_Z  (220)//(3*60)
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  167, -16, (Z_MIN_POS + 3) } }
  #define NOZZLE_CLEAN_END_POINT   { { 180, -56, (Z_MIN_POS + 3) } }
